...
race_id_list_a = ['2021060508{}'.format(str(i).zfill(2)) for i in range(1, 13, 1)]
race_id_list_b = ['2021090608{}'.format(str(i).zfill(2)) for i in range(1, 13, 1)]
...
rc = st.scrape(race_id_list,"2021/12/26")
