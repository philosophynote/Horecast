...
race_id_list_a = ['2022060102{}'.format(str(i).zfill(2)) for i in range(1, 13, 1)]
race_id_list_b = ['2022070102{}'.format(str(i).zfill(2)) for i in range(1, 13, 1)]
...
rc = st.scrape(race_id_list,"2022/01/08")
